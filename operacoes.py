...
def inserir_receita(nome, categoria_id, descricao,valor): 
    ...
    with con:
        ...
        cur.execute(query, (nome, categoria_id, descricao,valor))
...
#atualizar usuario
def editar_usuario(usuario_id, novo_nome, novo_email):
    with con:
        cur = con.cursor()
